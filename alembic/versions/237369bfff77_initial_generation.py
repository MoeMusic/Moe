...
Revision ID: 237369bfff77
Revises:
Create Date: 2021-05-25 18:38:46.990090
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("path", moe.core.library.track._PathType(), nullable=False),
        sa.Column("title", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("track_path", moe.core.library.track._PathType(), nullable=True),
        sa.ForeignKeyConstraint(
            ["genre"],
            ["genres.name"],
        ),
